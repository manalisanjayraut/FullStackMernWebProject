...
import { userLogoutAction, userProfileAction } from '../../redux/actions/userAction.ts';
import { useNavigate } from 'react-router-dom';
import LoginIcon from '@mui/icons-material/Login';
/**
 * The `SidebarAdm` component represents the sidebar in the admin dashboard.
 * It includes navigation links based on the user's role (admin or regular user).
 *
 * @component
 * @name SidebarAdm
 * @category Components
...
const SidebarAdm = () => {
    ...
    /**
     * Handles the logout action by dispatching the userLogoutAction and navigating to the home page.
     * @function
     * @name logOut
     */ 
    const logOut = () => {
    ...
    return (
        <>
            <Sidebar backgroundColor="#EFEFEF" style={{ borderRightStyle: "none" }}>
